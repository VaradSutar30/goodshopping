        ...
        <>
            <div className="banner md:h-[543px] h-auto w-full bg-[#211C24] md:flex gap-14 items-center text-center md:text-start flex-row">
                <div className="heading w-auto md:h-[] md:ml-[85px]">
                    <h4 className='text-[25px] font-semibold text-green-300 opacity-[40%] pt-[40px] md:pt-0'>Samsung Galaxy S25 Ultra </h4>
                    <h1 className='md:text-5xl text-4xl text-white font-thin mt-2 mb-2'>Galaxy S25<span className='font-semibold text-[#fac039]'>Ultra</span></h1>
